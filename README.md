...
This repository contains the custom Python scripts used for the computational analyses in the published manuscript:
...
Broetto, L. (2026). Computational Analysis Scripts for Exploratory data analysis and docking analysis of proteins (v1.1.0) Version associated with published article [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.18944319
...
@software{broetto_docking_analysis_2026,
  ...
  title        = {{Computational Analysis Scripts for Exploratory data analysis and docking analysis of proteins}},
  month        = jan,
  year         = 2026,
  publisher    = {Zenodo},
  version      = {v1.1.0},
